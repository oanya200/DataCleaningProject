...
Анна Петрулевич (@oanya200 в Telegram)

## Выводы

В проекте были рассмотрены различные и наиболее используемые приеме по очистке данных от дубликатов, выбросов, пропусков. В результате мы освежили в памяти все доступные методы очистки, а также подготовили данные по квартирам к дальнейшей обработке и извучению.